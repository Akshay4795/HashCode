...
public class Solution {
    ...
    private static List<Project> finalProjects = new ArrayList<>();
    ...
    private static void Output() throws Exception {
        ...
        output.append(finalProjects.size());
        for(Project project : finalProjects) {
            output.append(System.lineSeparator()).append(project.getInfoForOutput());
        }
